...
bgcol = [0.251 0.4157 0.502];
F = figure;
set(F,'units', 'normalized', 'position', [0.257 0.342 0.49 0.448],...
    'color',bgcol,...
    'MenuBar','None','Name','H5creator','NumberTitle','off');
...
set(mTextBox0,'String','MOT.CORR.','FontSize',10,'foregroundcolor',[0.8588 0.4471 0.3451],...
...
set(mTextBox1,'String','MESCROI','FontSize',10,'foregroundcolor',[0.8588 0.4471 0.3451],...
    'backgroundcolor',bgcol,'fontweight','bold','Tag','Unique');

mTextBox2 = uicontrol(F,'style','text','Units','Normalized',...
    'Position',[0.675 0.85 0.1 0.05]);
set(mTextBox2,'String','BEHAVIOR','FontSize',10,'foregroundcolor',[0.8588 0.4471 0.3451],...
    'backgroundcolor',bgcol,'fontweight','bold','Tag','Unique');

mTextBox3 = uicontrol(F,'style','text','Units','Normalized',...
    'Position',[0.4 0.94 0.1 0.05]);
set(mTextBox3,'String','ID: ','FontSize',10,'foregroundcolor',[0.4667 0.8235 0.8784],...
    'backgroundcolor',bgcol,'fontweight','bold','Tag','Unique');
ed = uicontrol(F,'Style', 'edit', 'String', 'none',...
    'tag','editbox0',...
    'Units','Normalized','Position', [0.46, 0.945, 0.1,0.05],'FontSize',9,...
    'Callback',@local_ID);
