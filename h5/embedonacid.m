function out = embedonacid(file_loc, datapaths, onacidpath, stageids)
% out = embedonacid(file_loc, datapaths, stageids) - one by one embeds data
...
for idata = 1:Ndata
    ...
    out = datareduced2hdf5(file_loc, data, stagetag);
end